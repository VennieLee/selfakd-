...
class Loss(nn.modules.loss._Loss):
    def __init__(self, args, ckp):
        ...
        self.loss.append({'type': "OS", 'weight': TS_weight, 'function': nn.L1Loss()})
    ...
    def forward(self, student_sr, hr):
        # DS Loss
        DS_loss = self.loss[0]['function'](student_sr, hr)
