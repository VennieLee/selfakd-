...
parser.add_argument("hr_img_dir", default='D:\fakd\code\data\dataset\benchmark\B100\HR', help="path to high resolution image dir")
...
for filename in os.listdir(hr_image_dir):
    ...
    # Downsample image 6x
    lr_img_6x = cv2.resize(hr_img, (0, 0), fx=1/4, fy=1/4,
                           interpolation=cv2.INTER_CUBIC)
    if args.keepdims:
