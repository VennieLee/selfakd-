...
# Dataset Setting
parser.add_argument('--dir_data', type=str, default='D:/fakd/code/data/dataset', help='dataset directory')
...
parser.add_argument('--data_range', type=str, default='1-660', help='train/test data range')
...
# storage setting
parser.add_argument('--ckp_dir', type=str, default='self_SRResnet', help='checkpoint directory')
...
parser.add_argument('--alpha', type=float, default=0.1, help='TS loss coefficient')
parser.add_argument('--model', default='SelfSRRes', help='student model name')
#parser.add_argument('--feature_distilation_type', default="1*SA", type=str, help='feature distilation type')
parser.add_argument('--feature_loss_used', default=0, type=int, help='whether to use feature loss')
#parser.add_argument('--features', default="[1,2,3]", type=str, help='features selected')
parser.add_argument('--teacher', default="[SelfSRRes]", type=str, help='teachers selected')
parser.add_argument('--student_n_resblocks', type=int, default=6, help='number of residual blocks')



# Testing
parser.add_argument('--ckp_path', type=str, default='D:/fakd/experiment/self_SRResnet/model/model_best.pt', help='checkpoint path')
