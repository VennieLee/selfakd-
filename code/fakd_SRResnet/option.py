...
# storage setting
parser.add_argument('--ckp_dir', type=str, default='fakd_SRResnet', help='checkpoint directory')
...
parser.add_argument('--model', default='FakdSRRes', help='student model name')
...
parser.add_argument('--teacher', default="[FakdSRRes]", type=str, help='teachers selected')
...
# Testing
parser.add_argument('--ckp_path', type=str, default='D:/fakd/experiment/fakd_SRResnet/model/model_best.pt', help='checkpoint path')
