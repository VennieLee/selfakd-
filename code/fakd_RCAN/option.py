...
# storage setting
parser.add_argument('--ckp_dir', type=str, default='RCAN', help='checkpoint directory')
...
# Testing
parser.add_argument('--ckp_path', type=str, default='D:/fakd/experiment/fakd_RCAN/model/model_best.pt', help='checkpoint path')
