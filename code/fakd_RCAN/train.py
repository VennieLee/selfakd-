...
sys.path.append(os.path.dirname(os.path.dirname('D:/fakd/code/fakd_RCAN/train.py')))
import data
...
def load_teachers():
    ...
    if "RCAN" in args.teacher:
        ...
        if int(args.scale[0]) == 2:
            ...
            net.load_state_dict_teacher(torch.load('D:/fakd/teacher_checkpoint/RCAN_BIX2.pt'))
        elif int(args.scale[0]) == 3:
            print("loading RCANx3")
            net.load_state_dict_teacher(torch.load('D:/fakd/teacher_checkpoint/RCAN_BIX3.pt'))
        elif int(args.scale[0]) == 4:
            print("loading RCANx4")
            net.load_state_dict_teacher(torch.load('D:/fakd/teacher_checkpoint/RCAN_BIX4.pt'))
        elif int(args.scale[0]) == 8:
            print("loading RCANx8")
            net.load_state_dict_teacher(torch.load('D:/fakd/teacher_checkpoint/RCAN_BIX8.pt'))
